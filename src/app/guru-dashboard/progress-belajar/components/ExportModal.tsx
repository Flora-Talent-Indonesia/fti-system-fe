      ...
      <div className="relative z-10 w-full max-w-xl bg-white rounded-xl shadow-2xl flex flex-col overflow-hidden max-h-[90vh]">
          ...
          <div className="space-y-4">
            <label className="block">
              ...
              <select
                ...
                className="mt-2 w-full border border-gray-300 rounded-md bg-white px-4 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#fc809f]/50 shadow-sm transition-shadow cursor-pointer"
              >
            ...
            <div className="border border-gray-200 rounded-md bg-white shadow-sm flex flex-col h-[280px]">
              <div className="flex items-center justify-between px-4 py-3 bg-gray-50 border-b border-gray-200 shrink-0">
                ...
                <button
                  onClick={toggleAll}
                  className="text-xs font-medium text-[#fc809f] hover:text-[#fc809f] flex items-center gap-1.5 transition-colors bg-[#fc809f]/10 px-2 py-1 rounded-md"
                >
                  ...
                  studentsInTarget.map(s => (
                    ...
                    >
                      <input
                        ...
                        className="w-4 h-4 text-[#fc809f] rounded border-gray-300 focus:ring-[#fc809f]/50 transition-colors"
                      />
            ...
            <div className="p-4 bg-[#fc809f]/10 rounded-lg border border-[#fc809f]/20 flex items-start gap-3 text-sm text-[#fc809f] leading-relaxed shadow-sm">
        ...
        <div className="px-6 py-4 border-t border-gray-100 bg-white flex items-center justify-end gap-3 shrink-0 shadow-sm">
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-2.5 text-sm font-medium rounded-lg bg-[#fc809f] text-white hover:bg-[#fc809f] disabled:bg-blue-300 disabled:cursor-not-allowed transition-colors shadow-sm"
          >

  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'absolute', bottom: '8mm', left: '15mm', fontSize: 8, color: '#999', letterSpacing: '0.1em' }}>
        LMS GWK — Laporan Progress Belajar
      </div>
    </div>
  );
}
...
const buildStudentPageHtml = (student: ProgressRow, n5Only: boolean): string => {
  ...
  return `
    <div style="width:210mm;height:297mm;padding:12mm 15mm;box-sizing:border-box;background:white;page-break-after:always;position:relative;overflow:hidden;font-family:'Noto Sans JP','Meiryo','MS Gothic',sans-serif;color:#000">
      ...
      <div style="position:absolute;bottom:8mm;left:15mm;font-size:8px;color:#999;letter-spacing:0.1em">LMS GWK — Laporan Progress Belajar</div>
    </div>`;
};
      ...
      <div className="fixed inset-0 z-[200] bg-white flex flex-col">
        ...
        <div className="bg-white px-6 py-3 flex items-center justify-between border-b shadow-sm shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={handlePrint}
              className="flex items-center gap-2 px-5 py-2 text-sm font-semibold bg-[#fc809f] text-white hover:bg-[#fc809f] rounded-lg transition-colors shadow-sm"
            >
              <Printer size={16} />
              Print Sekarang
            </button>
    ...
    <div className="fixed inset-0 z-[150] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-xl bg-white rounded-xl shadow-2xl flex flex-col overflow-hidden max-h-[92vh]">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 shrink-0">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-[#fc809f]/10 text-[#fc809f] rounded-lg">
              <Printer size={20} />
            </div>
        ...
        <div className="p-6 space-y-5 bg-gray-50/50 overflow-y-auto flex-1">
          ...
          <label className="block">
            ...
            <select
              ...
              className="mt-2 w-full border border-gray-300 rounded-md bg-white px-4 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#fc809f]/50 shadow-sm"
            >
          ...
          <div className="border border-gray-200 rounded-md bg-white shadow-sm flex flex-col h-[240px]">
            <div className="flex items-center justify-between px-4 py-3 bg-gray-50 border-b border-gray-200 shrink-0">
              ...
              <button
                onClick={toggleAll}
                className="text-xs font-medium text-[#fc809f] hover:text-[#fc809f] flex items-center gap-1.5 bg-[#fc809f]/10 px-2 py-1 rounded-md transition-colors"
              >
                ...
                studentsInTarget.map(s => (
                  ...
                  >
                    <input
                      ...
                      className="w-4 h-4 text-[#fc809f] rounded border-gray-300 focus:ring-[#fc809f]/50"
                    />
                    <div className="flex flex-col">
                      <span className="text-sm font-medium text-gray-900 group-hover:text-[#fc809f] transition-colors">{s.nama_lengkap}</span>
          ...
          <div className="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-sm">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#fc809f]/50 focus:ring-offset-2 ${n5Only ? 'bg-[#fc809f]' : 'bg-gray-200'}`}
            >
          ...
          {/* Info */}
          <div className="p-4 bg-[#fc809f]/10 rounded-lg border border-[#fc809f]/20 flex items-start gap-3 text-sm text-[#fc809f] leading-relaxed">
        ...
        <div className="px-6 py-4 border-t border-gray-100 bg-white flex items-center justify-between gap-3 shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-2.5 text-sm font-semibold rounded-lg bg-[#fc809f] text-white hover:bg-[#fc809f] disabled:bg-blue-300 disabled:cursor-not-allowed transition-colors shadow-sm"
          >
            <Eye size={16} />

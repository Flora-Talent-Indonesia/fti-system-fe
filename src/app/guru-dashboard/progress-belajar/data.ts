...
export const emptyNilaiRevisions = (): NilaiRevisions => ({
  aspects: {},
  sub_nilai: '',
  kepribadian: ''
});

export type MateriAspect = 'kotoba' | 'bunpou' | 'choukai' | 'kaiwa' | 'kanji';
export type NilaiSaveScope = 'exams' | 'kepribadian' | MateriAspect;
export const MATERI_ASPECTS: MateriAspect[] = ['kotoba', 'bunpou', 'choukai', 'kaiwa', 'kanji'];

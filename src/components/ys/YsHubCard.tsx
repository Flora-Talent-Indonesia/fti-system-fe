...
/** Kartu navigasi YS — judul Jepang utama, Inggris di bawah (seperti FTI hub). */
export default function YsHubCard({ href, icon: Icon, titleJa, titleEn, ctaJa, ctaEn }: Props) {
  return (
    <Link
      href={href}
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-xs text-gray-500 tracking-widest mb-6 font-medium">{titleEn}</p>
        <div className="flex flex-col gap-0.5">
          ...
          {ctaEn && (
            <span className="text-[10px] tracking-wider text-gray-400 font-medium">{ctaEn}</span>
          )}
        </div>
      </div>
    </Link>

        ...
        <table style={tbl()}>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style={cell({ verticalAlign: 'middle' })} colSpan={3} rowSpan={2}>
                <div
                  style={{
                    display: 'flex',
                    alignItems: 'center',
                ...
                >
                  <span style={{ flex: '1 1 auto', lineHeight: 1.4 }}>{info.alamat_lengkap || '-'}</span>
                  <span
                    style={{
                      flexShrink: 0,
                      whiteSpace: 'nowrap',
            ...
            <tr>
              ...
              <td style={cell({ padding: 0 })} colSpan={5}>
                <div style={{ display: 'flex', alignItems: 'stretch', minHeight: '26px' }}>
                  <div
                    style={{
                      flex: '0 0 42%',
                      padding: '4px 8px',
                  ...
                  >
                    <span style={{ color: '#374151', whiteSpace: 'nowrap' }}>メール：</span>
                    <span style={{ color: '#4a86e8', wordBreak: 'break-all' }}>{info.email || '-'}</span>
                  </div>
                </div>
              </td>
            </tr>
